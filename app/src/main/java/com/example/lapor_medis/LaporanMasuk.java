...
public class LaporanMasuk extends AppCompatActivity {
    ...
    public void getData(){
        initializeArray();
        //URL API
        AndroidNetworking.get("https://tekajeapunya.com/kelompok_9/lapormedis/getLaporanMasukMedis.php")
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status){
                                ...
                                Toast.makeText(LaporanMasuk.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception e){
                            e.printStackTrace();
